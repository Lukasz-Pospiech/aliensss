...
//MENU
// document.getElementById("headcut5").src = "headcut5.png";
...
//MENU
// document.getElementById("headcut5").src = "headcut5Desktop.png";
let menuOpenedOrClosed = "closed"; 
function showMenu() {
    if (menuOpenedOrClosed === "closed") {
        document.getElementById("menuContainer").style.display = "flex";
...
//DIAMOND
let diamondPosition = "normal";
function rotateDiamond() {
    if (diamondPosition === "normal") {
        document.getElementById("diamond").className = "diamondSingleRotation";
        diamondPosition = "flipped";
    }
    else {
        document.getElementById("diamond").className = "diamondSingleRotationBack";
        diamondPosition = "normal";
    }
